...
class FlashCard extends Component {
    ...
    nextPerson = () => {
        if (this.state.indexForSplice < 24) {
            this.setState({indexForSplice: this.state.indexForSplice + 1})
        }
        console.log(this.state.indexForSplice);
    }

    previousPerson = () => {
        if (this.state.indexForSplice > 0 ) {
            this.setState({indexForSplice: this.state.indexForSplice - 1})
        } 
        console.log(this.state.indexForSplice);
    }
    ...
    render() {
      ...
      const person = this.state.people.slice(this.state.indexForSplice, this.state.indexForSplice + 1).map(people => {
          return (<div>
        ...
        <div className="content">
          <div className="flashCard">
            ...
            <div className="header">
              <div className="number"> {people.id} /25 </div>
            </div>

            <div className="info"> 
                <div className="name"> {people.name.first} {people.name.last} </div> 

                <div className="details">

                  <div>
                    <span className="heavy">From:</span>
                    <span> {people.city}, {people.country} </span>
                  </div>

                  <div>
                    <span className="heavy">Job Title:</span>
                    <span> {people.title} </span>
                  </div>

                  <div>
                    <span className="heavy">Employer: </span>
                    <span> {people.employer} </span>
                  </div>
                ...
                <ol>
                  <li> {people.favoriteMovies[0]} </li>  
                  <li> {people.favoriteMovies[1]} </li>  
                  <li> {people.favoriteMovies[2]} </li>  
                </ol>
                </div>
            </div>
          ...
          <div className="footer">
            ...
            <div className="left" onClick={() => this.previousPerson()}>&lt; Previous</div>         {/*change these to button if you have to */}


            <div className="middle">

              <div className="left">Edit</div>          {/*OnClick*/}

              <div className="middle">Delete</div>          {/*OnClick*/}

              <div className="right">New</div>          {/*OnClick*/}

            </div>


            <div className="right" onClick={() => this.nextPerson()}>Next &gt;</div>          {/*OnClick*/}
